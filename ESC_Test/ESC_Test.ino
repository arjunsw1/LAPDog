...
int Init_PB = 7;  // Flight initiation PB input
int Init_LED = 8; // Flight initiation PB LED output

void setup() {
  Serial.begin(9600);  // start serial at 9600 baud
  
  // ESC minimum speed = 1ms pulse width, ESC maximum speed = 2ms
  FL_ESC.attach(9,1000,2000);    // Front left ESC attached to pin 9
  FR_ESC.attach(5,1000,2000);    // Front left ESC attached to pin 5
  RL_ESC.attach(6,1000,2000);    // Front left ESC attached to pin 6
  RR_ESC.attach(3,1000,2000);    // Front left ESC attached to pin 3
}
